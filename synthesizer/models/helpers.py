...
from helpers import helper as helper_py

class TacoTestHelper(helper_py.Helper):
...
class TacoTrainingHelper(helper_py.Helper):
...
def _teacher_forcing_ratio_decay(init_tfr, global_step, hparams):
		...
		tfr = tf.compat.v1.train.cosine_decay(init_tfr,
