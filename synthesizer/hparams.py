from helpers.hparam import HParams
...
hparams = HParams(
    ...
    #hop_size=275,  # For 16000Hz, 200 = 12.5 ms (0.0125 * sample_rate)
    #win_size=1102,  # For 16000Hz, 800 = 50 ms (If None, win_size = n_fft) (0.05 * sample_rate)
    ...
    #hop_size=551,  # For 16000Hz, 200 = 12.5 ms (0.0125 * sample_rate)
    #win_size=2205,  # For 16000Hz, 800 = 50 ms (If None, win_size = n_fft) (0.05 * sample_rate)
    #sample_rate=44100,  # 16000Hz (corresponding to librispeech) (sox --i <filename>)      
